                    ...
                    If strand.HasSubsect Then
                        ...
                        While (iter.MoveNext)
                            ...
                            For j = 0 To fields.Count - 1
                                ...
                                doc.Add(New Field(name, values(j), CType(fields(j).Attributes("isStored").Value, Boolean), CType(fields(j).Attributes("isIndexed").Value, Boolean), CType(fields(j).Attributes("isTokenised").Value, Boolean)))
